        ...
        @foreach ($paralelos as $paralelo)
          <tr>
            ...
            <td>
                ...
                ></a>
                <a class="btn btn-danger icon-bin" data-toggle="tooltip" title="Eliminar" href="AdminParalelos/{{$paralelo->id}}/delete" data-confirm="¿Estas seguro que quieres eliminar a {{$paralelo->nombre}}?"></a>
            </td>
          </tr>
        @endforeach
